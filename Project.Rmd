...
The split which splits the users into two groups based on the value of the train parameter and uses the first half of the split to train the model, and the second half to evaluate the model. If using an all-but-x scheme, then the scheme uses only the second half of the split to exclude ratings from.
...
error5 <- rbind(
h = calcPredictionAccuracy(hybrid_predict, getData(anime_eval_split_min, "unknown")),
h2 = calcPredictionAccuracy(hybrid_predict2, getData(anime_eval_split_allbut5, "unknown")),
h3 = calcPredictionAccuracy(hybrid_predict3, getData(anime_eval_cross_allbut5, "unknown")),
h4 = calcPredictionAccuracy(hybrid_predict4, getData(anime_eval_cross_min, "unknown")))
...
error_total_split_min <- error_total[c("ibcf","ubcf","als","svd","h"),]
error_total_split_allbut5 <- error_total[c("ibcf2","ubcf2","als2","svd2","h2"),]
error_total_cross_allbut5 <- error_total[c("ibcf3","ubcf3","als3","svd3","h3"),]
error_total_cross_min <- error_total[c("ibcf4","ubcf4","als4","svd4","h4"),]
...
ggplot(data = error_total_split_min_melted,aes(x=reorder(algo_type,value),y=value,fill=variable)) +
  ...
  labs(col="Error Type") +
  ylim(0,10)+
  ggtitle("Error Values for All Different Algorithms, Using Split + Minimum Given Values")
...
ggplot(data = error_total_split_allbut5_melted,aes(x=reorder(algo_type,value),y=value,fill=variable)) +
  ...
  labs(col="Error Type") +
  ylim(0,10)+
  ggtitle("Error Values for All Different Algorithms, Using Split + All-But-5 Given Values")
...
ggplot(data = error_total_cross_allbut5_melted,aes(x=reorder(algo_type,value),y=value,fill=variable)) +
  ...
  labs(col="Error Type") +
  ylim(0,10)+
  ggtitle("Error Values for All Different Algorithms, Using Cross + All-But-5 Given Values")
...
ggplot(data = error_total_cross_min_melted,aes(x=reorder(algo_type,value),y=value,fill=variable)) +
  ...
  labs(col="Error Type") +
  ylim(0,10)+
  ggtitle("Error Values for All Different Algorithms, Using Cross + Minimum Given Values")
```
...
save(results, file="roc_results.rda")
load("roc_results.rda")
```
